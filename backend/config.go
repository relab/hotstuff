...
func (cfg *Config) Propose(proposal msg.ProposeMsg) {
	if cfg.cfg == nil {
		return
	}
	var ctx context.Context
...
func (cfg *Config) Timeout(timeoutMsg msg.TimeoutMsg) {
	if cfg.cfg == nil {
		return
	}
	var ctx context.Context
...
func (cfg *Config) Fetch(ctx context.Context, hash msg.Hash) (*msg.Block, bool) {
