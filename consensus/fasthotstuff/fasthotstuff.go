...
func (fhs *FastHotStuff) qcRef(qc hs.QuorumCert) (*hs.Block, bool) {
...
func (fhs *FastHotStuff) CommitRule(block *hs.Block) *hs.Block {
...
func (fhs *FastHotStuff) VoteRule(proposal hs.ProposeMsg) bool {
