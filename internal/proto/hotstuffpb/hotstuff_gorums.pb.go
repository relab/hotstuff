...
func (c *Configuration) Fetch(ctx context.Context, in *BlockHash) (resp *Block, err error) {
	cd := gorums.QuorumCallData{
		Message: in,
		Method:  "hotstuffpb.Consensus.Fetch",
	}
...
func RegisterConsensusServer(srv *gorums.Server, impl Consensus) {
	...
	srv.RegisterHandler("hotstuffpb.Consensus.Fetch", func(ctx gorums.ServerCtx, in *gorums.Message, finished chan<- *gorums.Message) {
