...
type ReplicaOpts struct {
	...
	LeaderElection string `protobuf:"bytes,10,opt,name=LeaderElection,proto3" json:"LeaderElection,omitempty"`
	...
	ConnectTimeout float32 `protobuf:"fixed32,17,opt,name=ConnectTimeout,proto3" json:"ConnectTimeout,omitempty"`
	// The initial view duration in milliseconds.
	InitialTimeout float32 `protobuf:"fixed32,12,opt,name=InitialTimeout,proto3" json:"InitialTimeout,omitempty"`
	...
	BlockCacheSize uint32 `protobuf:"varint,15,opt,name=BlockCacheSize,proto3" json:"BlockCacheSize,omitempty"`
}
...
func (x *ReplicaOpts) GetLeaderElection() string {
	if x != nil {
...
func (x *ReplicaOpts) GetConnectTimeout() float32 {
	if x != nil {
...
func (x *ReplicaOpts) GetInitialTimeout() float32 {
	if x != nil {
...
func (x *ReplicaOpts) GetBlockCacheSize() uint32 {
	if x != nil {
...
type ClientOpts struct {
	...
	ConnectTimeout float32 `protobuf:"fixed32,10,opt,name=ConnectTimeout,proto3" json:"ConnectTimeout,omitempty"`
}
...
func (x *ClientOpts) GetConnectTimeout() float32 {
	if x != nil {
		return x.ConnectTimeout
	}
	return 0
...
type ReplicaStreamResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to Message:
	//	*ReplicaStreamResponse_LogLine
	//	*ReplicaStreamResponse_Result
	Message isReplicaStreamResponse_Message `protobuf_oneof:"Message"`
}

func (x *ReplicaStreamResponse) Reset() {
	*x = ReplicaStreamResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReplicaStreamResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReplicaStreamResponse) ProtoMessage() {}

func (x *ReplicaStreamResponse) ProtoReflect() protoreflect.Message {
	mi := &file_internal_proto_orchestrationpb_orchestration_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReplicaStreamResponse.ProtoReflect.Descriptor instead.
func (*ReplicaStreamResponse) Descriptor() ([]byte, []int) {
	return file_internal_proto_orchestrationpb_orchestration_proto_rawDescGZIP(), []int{7}
}

func (m *ReplicaStreamResponse) GetMessage() isReplicaStreamResponse_Message {
	if m != nil {
		return m.Message
	}
	return nil
...
func (x *ReplicaStreamResponse) GetLogLine() *LogLine {
	if x, ok := x.GetMessage().(*ReplicaStreamResponse_LogLine); ok {
		return x.LogLine
	}
	return nil
}

func (x *ReplicaStreamResponse) GetResult() *Result {
	if x, ok := x.GetMessage().(*ReplicaStreamResponse_Result); ok {
		return x.Result
	}
	return nil
}

type isReplicaStreamResponse_Message interface {
	isReplicaStreamResponse_Message()
}

type ReplicaStreamResponse_LogLine struct {
	LogLine *LogLine `protobuf:"bytes,1,opt,name=LogLine,proto3,oneof"`
}

type ReplicaStreamResponse_Result struct {
	Result *Result `protobuf:"bytes,2,opt,name=Result,proto3,oneof"`
}

func (*ReplicaStreamResponse_LogLine) isReplicaStreamResponse_Message() {}

func (*ReplicaStreamResponse_Result) isReplicaStreamResponse_Message() {}
...
func (x *LogLine) GetLogLevel() int32 {
	if x != nil {
		return x.LogLevel
	}
	return 0
...
type Result struct {
	...
	ID           uint32 `protobuf:"varint,1,opt,name=ID,proto3" json:"ID,omitempty"`
	CommandsHash []byte `protobuf:"bytes,2,opt,name=CommandsHash,proto3" json:"CommandsHash,omitempty"`
}
...
func (x *Result) GetCommandsHash() []byte {
	if x != nil {
		return x.CommandsHash
	}
	return nil
}
...
var file_internal_proto_orchestrationpb_orchestration_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x02, 0x38, 0x01, 0x22, 0xc2, 0x01, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65,
	0x70, 0x6c, 0x69, 0x63, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x4f, 0x0a, 0x08,
	...
	0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x52, 0x65,
	...
	,
	...
	0xe6, 0x01, 0x0a, 0x13, 0x53, 0x74, 0x61, 0x72, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x49, 0x44, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0d, 0x52, 0x03, 0x49, 0x44, 0x73, 0x12, 0x5d, 0x0a, 0x0d, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x37, 0x2e, 0x6f, 0x72, 0x63, 0x68, 0x65, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x5e, 0x0a, 0x12, 0x43, 0x6f, 0x6e, 0x66,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x22, 0x08, 0xa0, 0xb5, 0x18, 0x01, 0xa0, 0xb6, 0x18, 0x01, 0x42, 0x3a, 0x5a, 0x38, 0x67,
	...
	0x6c, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6f, 0x72, 0x63, 0x68, 0x65, 0x73, 0x74, 0x72,
...
var file_internal_proto_orchestrationpb_orchestration_proto_goTypes = []interface{}{
	...
	(*ReplicaStreamResponse)(nil), // 7: orchestrationpb.ReplicaStreamResponse
	...
	(*LogLine)(nil),               // 14: orchestrationpb.LogLine
	(*Result)(nil),                // 15: orchestrationpb.Result
...
var file_internal_proto_orchestrationpb_orchestration_proto_depIdxs = []int32{
	16, // 0: orchestrationpb.ReplicaConfiguration.Replicas:type_name -> orchestrationpb.ReplicaConfiguration.ReplicasEntry
	17, // 1: orchestrationpb.CreateReplicaRequest.Replicas:type_name -> orchestrationpb.CreateReplicaRequest.ReplicasEntry
	18, // 2: orchestrationpb.CreateReplicaResponse.Replicas:type_name -> orchestrationpb.CreateReplicaResponse.ReplicasEntry
	19, // 3: orchestrationpb.StartReplicaRequest.Configuration:type_name -> orchestrationpb.StartReplicaRequest.ConfigurationEntry
	14, // 4: orchestrationpb.ReplicaStreamResponse.LogLine:type_name -> orchestrationpb.LogLine
	15, // 5: orchestrationpb.ReplicaStreamResponse.Result:type_name -> orchestrationpb.Result
	20, // 6: orchestrationpb.StartClientRequest.Clients:type_name -> orchestrationpb.StartClientRequest.ClientsEntry
	21, // 7: orchestrationpb.StartClientRequest.Configuration:type_name -> orchestrationpb.StartClientRequest.ConfigurationEntry
	22, // 8: orchestrationpb.LogLine.Time:type_name -> google.protobuf.Timestamp
	1,  // 9: orchestrationpb.ReplicaConfiguration.ReplicasEntry.value:type_name -> orchestrationpb.ReplicaInfo
	0,  // 10: orchestrationpb.CreateReplicaRequest.ReplicasEntry.value:type_name -> orchestrationpb.ReplicaOpts
	1,  // 11: orchestrationpb.CreateReplicaResponse.ReplicasEntry.value:type_name -> orchestrationpb.ReplicaInfo
	1,  // 12: orchestrationpb.StartReplicaRequest.ConfigurationEntry.value:type_name -> orchestrationpb.ReplicaInfo
	2,  // 13: orchestrationpb.StartClientRequest.ClientsEntry.value:type_name -> orchestrationpb.ClientOpts
	1,  // 14: orchestrationpb.StartClientRequest.ConfigurationEntry.value:type_name -> orchestrationpb.ReplicaInfo
	4,  // 15: orchestrationpb.Orchestrator.CreateReplica:input_type -> orchestrationpb.CreateReplicaRequest
	6,  // 16: orchestrationpb.Orchestrator.StartReplica:input_type -> orchestrationpb.StartReplicaRequest
	8,  // 17: orchestrationpb.Orchestrator.StopReplica:input_type -> orchestrationpb.StopReplicaRequest
	10, // 18: orchestrationpb.Orchestrator.StartClient:input_type -> orchestrationpb.StartClientRequest
	12, // 19: orchestrationpb.Orchestrator.StopClient:input_type -> orchestrationpb.StopClientRequest
	5,  // 20: orchestrationpb.Orchestrator.CreateReplica:output_type -> orchestrationpb.CreateReplicaResponse
	7,  // 21: orchestrationpb.Orchestrator.StartReplica:output_type -> orchestrationpb.ReplicaStreamResponse
	9,  // 22: orchestrationpb.Orchestrator.StopReplica:output_type -> orchestrationpb.StopReplicaResponse
	11, // 23: orchestrationpb.Orchestrator.StartClient:output_type -> orchestrationpb.StartClientResponse
	13, // 24: orchestrationpb.Orchestrator.StopClient:output_type -> orchestrationpb.StopClientResponse
...
func file_internal_proto_orchestrationpb_orchestration_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_proto_orchestrationpb_orchestration_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReplicaStreamResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_internal_proto_orchestrationpb_orchestration_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*ReplicaStreamResponse_LogLine)(nil),
		(*ReplicaStreamResponse_Result)(nil),
	}
