...
const (
	ReplicaState_LEARN        ReplicaState = 0
	ReplicaState_ACTIVE       ReplicaState = 1
	ReplicaState_READ         ReplicaState = 2
	ReplicaState_STOP         ReplicaState = 3
	ReplicaState_ORCHESTRATOR ReplicaState = 4
)
...
func (ReplicaState) Descriptor() protoreflect.EnumDescriptor {
	return file_internal_proto_orchestrationpb_orchestration_proto_enumTypes[0].Descriptor()
}

func (ReplicaState) Type() protoreflect.EnumType {
	return &file_internal_proto_orchestrationpb_orchestration_proto_enumTypes[0]
}
...
type ReplicaOpts struct {
	...
	// ReplicaState represents the
	State ReplicaState `protobuf:"varint,21,opt,name=State,proto3,enum=orchestrationpb.ReplicaState" json:"State,omitempty"`
}
...
func (x *ReplicaOpts) GetState() ReplicaState {
	if x != nil {
		return x.State
	}
	return ReplicaState_LEARN
}
...
type ReplicaInfo struct {
	...
	State      ReplicaState `protobuf:"varint,6,opt,name=State,proto3,enum=orchestrationpb.ReplicaState" json:"State,omitempty"`
}
...
func (x *ReplicaInfo) GetState() ReplicaState {
	if x != nil {
		return x.State
	}
	return ReplicaState_LEARN
...
type ReconfigurationRequest struct {
	...
	Replicas map[uint32]ReplicaState `protobuf:"bytes,1,rep,name=replicas,proto3" json:"replicas,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=orchestrationpb.ReplicaState"`
}

func (x *ReconfigurationRequest) Reset() {
	*x = ReconfigurationRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReconfigurationRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReconfigurationRequest) ProtoMessage() {}

func (x *ReconfigurationRequest) ProtoReflect() protoreflect.Message {
	mi := &file_internal_proto_orchestrationpb_orchestration_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReconfigurationRequest.ProtoReflect.Descriptor instead.
func (*ReconfigurationRequest) Descriptor() ([]byte, []int) {
	return file_internal_proto_orchestrationpb_orchestration_proto_rawDescGZIP(), []int{15}
}

func (x *ReconfigurationRequest) GetReplicas() map[uint32]ReplicaState {
	if x != nil {
		return x.Replicas
	}
	return nil
...
var file_internal_proto_orchestrationpb_orchestration_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd2, 0x06, 0x0a, 0x0b, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63,
	...
	0x68, 0x61, 0x72, 0x65, 0x64, 0x53, 0x65, 0x65, 0x64, 0x12, 0x33, 0x0a, 0x05, 0x53, 0x74, 0x61,
	0x74, 0x65, 0x18, 0x15, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x6f, 0x72, 0x63, 0x68, 0x65,
	0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x70, 0x62, 0x2e, 0x52, 0x65, 0x70, 0x6c, 0x69,
	0x63, 0x61, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x42, 0x0e,
	...
	0x65, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x22, 0xcc, 0x01, 0x0a, 0x0b, 0x52,
	0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x44,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x49, 0x44, 0x12, 0x18, 0x0a, 0x07, 0x41, 0x64,
	...
	,
	...
	0x73, 0x74, 0x22, 0xc7, 0x01, 0x0a, 0x16, 0x52, 0x65, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75,
	...
	0x35, 0x2e, 0x6f, 0x72, 0x63, 0x68, 0x65, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x70,
	0x62, 0x2e, 0x52, 0x65, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f,
	...
	,
...
var file_internal_proto_orchestrationpb_orchestration_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_internal_proto_orchestrationpb_orchestration_proto_goTypes = []interface{}{
	(ReplicaState)(0),              // 0: orchestrationpb.ReplicaState
	(*ReplicaOpts)(nil),            // 1: orchestrationpb.ReplicaOpts
	(*ReplicaInfo)(nil),            // 2: orchestrationpb.ReplicaInfo
	(*ClientOpts)(nil),             // 3: orchestrationpb.ClientOpts
	...
	(*QuitRequest)(nil),            // 15: orchestrationpb.QuitRequest
	(*ReconfigurationRequest)(nil), // 16: orchestrationpb.ReconfigurationRequest
	...
	nil,                            // 24: orchestrationpb.ReconfigurationRequest.ReplicasEntry
...
var file_internal_proto_orchestrationpb_orchestration_proto_depIdxs = []int32{
	...
	0,  // 3: orchestrationpb.ReplicaOpts.State:type_name -> orchestrationpb.ReplicaState
	0,  // 4: orchestrationpb.ReplicaInfo.State:type_name -> orchestrationpb.ReplicaState
	25, // 5: orchestrationpb.ClientOpts.ConnectTimeout:type_name -> google.protobuf.Duration
	25, // 6: orchestrationpb.ClientOpts.RateStepInterval:type_name -> google.protobuf.Duration
	17, // 7: orchestrationpb.ReplicaConfiguration.Replicas:type_name -> orchestrationpb.ReplicaConfiguration.ReplicasEntry
	18, // 8: orchestrationpb.CreateReplicaRequest.Replicas:type_name -> orchestrationpb.CreateReplicaRequest.ReplicasEntry
	19, // 9: orchestrationpb.CreateReplicaResponse.Replicas:type_name -> orchestrationpb.CreateReplicaResponse.ReplicasEntry
	20, // 10: orchestrationpb.StartReplicaRequest.Configuration:type_name -> orchestrationpb.StartReplicaRequest.ConfigurationEntry
	21, // 11: orchestrationpb.StopReplicaResponse.Hashes:type_name -> orchestrationpb.StopReplicaResponse.HashesEntry
	22, // 12: orchestrationpb.StartClientRequest.Clients:type_name -> orchestrationpb.StartClientRequest.ClientsEntry
	23, // 13: orchestrationpb.StartClientRequest.Configuration:type_name -> orchestrationpb.StartClientRequest.ConfigurationEntry
	24, // 14: orchestrationpb.ReconfigurationRequest.replicas:type_name -> orchestrationpb.ReconfigurationRequest.ReplicasEntry
	2,  // 15: orchestrationpb.ReplicaConfiguration.ReplicasEntry.value:type_name -> orchestrationpb.ReplicaInfo
	1,  // 16: orchestrationpb.CreateReplicaRequest.ReplicasEntry.value:type_name -> orchestrationpb.ReplicaOpts
	2,  // 17: orchestrationpb.CreateReplicaResponse.ReplicasEntry.value:type_name -> orchestrationpb.ReplicaInfo
	2,  // 18: orchestrationpb.StartReplicaRequest.ConfigurationEntry.value:type_name -> orchestrationpb.ReplicaInfo
	3,  // 19: orchestrationpb.StartClientRequest.ClientsEntry.value:type_name -> orchestrationpb.ClientOpts
	2,  // 20: orchestrationpb.StartClientRequest.ConfigurationEntry.value:type_name -> orchestrationpb.ReplicaInfo
	0,  // 21: orchestrationpb.ReconfigurationRequest.ReplicasEntry.value:type_name -> orchestrationpb.ReplicaState
...
func file_internal_proto_orchestrationpb_orchestration_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_proto_orchestrationpb_orchestration_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReconfigurationRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_internal_proto_orchestrationpb_orchestration_proto_enumTypes,
