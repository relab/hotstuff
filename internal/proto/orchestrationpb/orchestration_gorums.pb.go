...
// Quit is a quorum call invoked on all nodes in configuration c,
// with the same argument in, and returns a combined result.
func (c *Configuration) Quit(ctx context.Context, in *emptypb.Empty, opts ...gorums.CallOption) {
	cd := gorums.QuorumCallData{
		Message: in,
		Method:  "orchestrationpb.Orchestrator.Quit",
	}
...
type Orchestrator interface {
	...
	Quit(ctx gorums.ServerCtx, request *emptypb.Empty)
}
...
func RegisterOrchestratorServer(srv *gorums.Server, impl Orchestrator) {
	...
	srv.RegisterHandler("orchestrationpb.Orchestrator.Quit", func(ctx gorums.ServerCtx, in *gorums.Message, _ chan<- *gorums.Message) {
