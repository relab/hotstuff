...
// ReconfigureRequest is a quorum call invoked on all nodes in configuration c,
// with the same argument in, and returns a combined result.
func (c *Configuration) ReconfigureRequest(ctx context.Context, in *orchestrationpb.ReconfigurationRequest, opts ...gorums.CallOption) {
	cd := gorums.QuorumCallData{
		Message: in,
		Method:  "clientpb.Client.ReconfigureRequest",
	}
...
type Client interface {
	...
	ReconfigureRequest(ctx gorums.ServerCtx, request *orchestrationpb.ReconfigurationRequest)
}
...
func RegisterClientServer(srv *gorums.Server, impl Client) {
	...
	srv.RegisterHandler("clientpb.Client.ReconfigureRequest", func(ctx gorums.ServerCtx, in *gorums.Message, _ chan<- *gorums.Message) {
		req := in.Message.(*orchestrationpb.ReconfigurationRequest)
		defer ctx.Release()
		impl.ReconfigureRequest(ctx, req)
	})
}
