...
type BlockAndNewLeader struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Block               *Block `protobuf:"bytes,1,opt,name=block,proto3" json:"block,omitempty"`
	SugestedNewLeaderID uint32 `protobuf:"varint,2,opt,name=sugestedNewLeaderID,proto3" json:"sugestedNewLeaderID,omitempty"`
}

func (x *BlockAndNewLeader) Reset() {
	*x = BlockAndNewLeader{}
	if protoimpl.UnsafeEnabled {
...
func (x *BlockAndNewLeader) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BlockAndNewLeader) ProtoMessage() {}

func (x *BlockAndNewLeader) ProtoReflect() protoreflect.Message {
	mi := &file_internal_proto_hotstuff_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BlockAndNewLeader.ProtoReflect.Descriptor instead.
func (*BlockAndNewLeader) Descriptor() ([]byte, []int) {
	return file_internal_proto_hotstuff_proto_rawDescGZIP(), []int{1}
}

func (x *BlockAndNewLeader) GetBlock() *Block {
	if x != nil {
		return x.Block
	}
	return nil
...
func (x *BlockAndNewLeader) GetSugestedNewLeaderID() uint32 {
	if x != nil {
		return x.SugestedNewLeaderID
	}
	return 0
}
...
var file_internal_proto_hotstuff_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x22, 0x69, 0x0a, 0x11, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x41, 0x6e, 0x64, 0x4e, 0x65,
	0x77, 0x4c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x22, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x42,
	0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x30, 0x0a, 0x13, 0x73,
	0x75, 0x67, 0x65, 0x73, 0x74, 0x65, 0x64, 0x4e, 0x65, 0x77, 0x4c, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x49, 0x44, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x13, 0x73, 0x75, 0x67, 0x65, 0x73, 0x74,
	0x65, 0x64, 0x4e, 0x65, 0x77, 0x4c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x49, 0x44, 0x22, 0x46, 0x0a,
	...
	0x04, 0x44, 0x61, 0x74, 0x61, 0x32, 0xc3, 0x01, 0x0a, 0x08, 0x48, 0x6f, 0x74, 0x73, 0x74, 0x75,
	0x66, 0x66, 0x12, 0x41, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x12, 0x18, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x41, 0x6e, 0x64, 0x4e, 0x65,
	0x77, 0x4c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x1a, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	...
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x04, 0xa8, 0xb5, 0x18, 0x01, 0x42, 0x2a, 0x5a, 0x28, 0x67,
...
var file_internal_proto_hotstuff_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_internal_proto_hotstuff_proto_goTypes = []interface{}{
	(*Block)(nil),             // 0: proto.Block
	(*BlockAndNewLeader)(nil), // 1: proto.BlockAndNewLeader
...
var file_internal_proto_hotstuff_proto_depIdxs = []int32{
	...
	5, // 1: proto.Block.Commands:type_name -> proto.Command
	0, // 2: proto.BlockAndNewLeader.block:type_name -> proto.Block
	2, // 3: proto.PartialCert.Sig:type_name -> proto.PartialSig
	2, // 4: proto.QuorumCert.Sigs:type_name -> proto.PartialSig
	1, // 5: proto.Hotstuff.Propose:input_type -> proto.BlockAndNewLeader
	3, // 6: proto.Hotstuff.Vote:input_type -> proto.PartialCert
	4, // 7: proto.Hotstuff.NewView:input_type -> proto.QuorumCert
	6, // 8: proto.Hotstuff.Propose:output_type -> google.protobuf.Empty
	6, // 9: proto.Hotstuff.Vote:output_type -> google.protobuf.Empty
	6, // 10: proto.Hotstuff.NewView:output_type -> google.protobuf.Empty
...
func file_internal_proto_hotstuff_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_proto_hotstuff_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BlockAndNewLeader); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
