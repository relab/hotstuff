...
func (m *MockSynchronizer) OnNewView(arg0 hotstuff.NewViewMsg) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "OnNewView", arg0)
}

// OnNewView indicates an expected call of OnNewView.
func (mr *MockSynchronizerMockRecorder) OnNewView(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OnNewView", reflect.TypeOf((*MockSynchronizer)(nil).OnNewView), arg0)
}

// OnRemoteTimeout mocks base method.
func (m *MockSynchronizer) OnRemoteTimeout(arg0 hotstuff.TimeoutMsg) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "OnRemoteTimeout", arg0)
}

// OnRemoteTimeout indicates an expected call of OnRemoteTimeout.
func (mr *MockSynchronizerMockRecorder) OnRemoteTimeout(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OnRemoteTimeout", reflect.TypeOf((*MockSynchronizer)(nil).OnRemoteTimeout), arg0)
}
